...
module SwaggerClient
  class AuditLogItemOld
    ...
    attr_accessor :requester_addr

    # Response message, if any.
    attr_accessor :resp_msg
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          allowed == o.allowed &&
          method == o.method &&
          requester_addr == o.requester_addr &&
          resp_msg == o.resp_msg &&
    ...
    def hash
      [action, allowed, method, requester_addr, resp_msg, response_time, t].hash
    end
