...
module SwaggerClient
  class VirtualNetworkEndpoint
    ...
    attr_accessor :network_fqn

    # A list of interfaces associated with the job.
    attr_accessor :end_point_interface
    ...
    def ==(o)
      ...
      self.class == o.class &&
          uuid == o.uuid &&
          fqn == o.fqn &&
          network_fqn == o.network_fqn &&
          end_point_interface == o.end_point_interface
    end
    ...
    def hash
      [uuid, fqn, network_fqn, end_point_interface].hash
    end
